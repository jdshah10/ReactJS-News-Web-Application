...
export default class PoliticsCardGuardian extends React.Component{
    constructor(props){
        super(props);
        this.state = {cardObj:{}, data: [], error: null, isL: true, newsProvider:''}
        this.fetchGuardianPoliticsCard = this.fetchGuardianPoliticsCard.bind(this);
    }

    componentDidMount(){
            this.fetchGuardianPoliticsCard();
        } 
        fetchGuardianPoliticsCard(){
        var newsSection = "politics";
