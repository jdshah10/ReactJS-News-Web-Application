...
export default class WorldCardNYTimes extends React.Component{
    constructor(props){
        super(props);
        this.state = {cardObj:{}, data: [], error: null, isL: true, newsProvider:''}
        
        this.fetchNYTimesWorldCard = this.fetchNYTimesWorldCard.bind(this);
    }

    componentDidMount(){
        this.fetchNYTimesWorldCard();
    }

    fetchNYTimesWorldCard(){
