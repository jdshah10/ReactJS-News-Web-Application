...
export default class SportsCardGuardian extends React.Component{
    constructor(props){
        super(props);
        this.state = {cardObj:{}, data: [], error: null, isL: true, newsProvider:''}
        this.fetchGuardianSportsCard = this.fetchGuardianSportsCard.bind(this);
    }

    componentDidMount(){
            this.fetchGuardianSportsCard();
        } 
        fetchGuardianSportsCard(){
        var newsSection = "sport";
