...
export default class BusinessCardNYTimes extends React.Component{
    constructor(props){
        super(props);
        this.state = {cardObj:{}, data: [], error: null, isL: true, newsProvider:''}
        
        this.fetchNYTimesBusinessCard = this.fetchNYTimesBusinessCard.bind(this);
    }

    componentDidMount(){
        this.fetchNYTimesBusinessCard();
    }

    fetchNYTimesBusinessCard(){
