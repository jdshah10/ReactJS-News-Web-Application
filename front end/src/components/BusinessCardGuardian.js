...
export default class BusinessCardGuardian extends React.Component{
    constructor(props){
        super(props);
        this.state = {cardObj:{}, data: [], error: null, isL: true, newsProvider:''}
        this.fetchGuardianBusinessCard = this.fetchGuardianBusinessCard.bind(this);
    }

    componentDidMount(){
            this.fetchGuardianBusinessCard();
        } 
        fetchGuardianBusinessCard(){
        var newsSection = "business";
