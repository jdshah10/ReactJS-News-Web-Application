...
export default class WorldCardGuardian extends React.Component{
    constructor(props){
        super(props);
        this.state = {cardObj:{}, data: [], error: null, isL: true, newsProvider:''}
        this.fetchGuardianWorldCard = this.fetchGuardianWorldCard.bind(this);
    }

    componentDidMount(){
            this.fetchGuardianWorldCard();
        } 
    fetchGuardianWorldCard(){
        var newsSection = "world";
