...
export default class SportsCardNYTimes extends React.Component{
    constructor(props){
        super(props);
        this.state = {cardObj:{}, data: [], error: null, isL: true, newsProvider:''}
        
        this.fetchNYTimesSportsCard = this.fetchNYTimesSportsCard.bind(this);
    }

    componentDidMount(){
        this.fetchNYTimesSportsCard();
    }

    fetchNYTimesSportsCard(){
        var newsSection = "sports";
