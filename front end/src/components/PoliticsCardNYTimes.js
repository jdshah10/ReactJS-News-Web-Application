...
export default class PoliticsCardNYTimes extends React.Component{
    constructor(props){
        super(props);
        this.state = {cardObj:{}, data: [], error: null, isL: true, newsProvider:''}
        
        this.fetchNYTimesPoliticsCard = this.fetchNYTimesPoliticsCard.bind(this);
    }

    componentDidMount(){
        this.fetchNYTimesPoliticsCard();
    }

    fetchNYTimesPoliticsCard(){
